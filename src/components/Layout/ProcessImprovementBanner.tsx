...
const ProcessImprovementBanner = () => {
  return (
    <div className="xl:pb-[143px] xs:pb-[100px] ">
      <div className="flex xl:flex-row xs:flex-col  lg:gap-52  xs:gap-[74px]">
        <div className="lg:text-[80px] lg:leading-[88px] xs:text-[48px] xs:leading-[52px] md:min-w-[470px]">Process Improvement</div>
        <div className="font-tahoma lg:text-[26px] xs:text-[24px] lg:leading-[35.1px] xs:leading-[32px] pt-5">
        Mana'o Pili provides process improvement consulting by capturing and analyzing baseline metrics to identify key areas for impact. Our experts make prescriptive recommendations that "move the needle," enhancing efficiency and delivering measurable improvements aligned with strategic business goals.
...
export default ProcessImprovementBanner