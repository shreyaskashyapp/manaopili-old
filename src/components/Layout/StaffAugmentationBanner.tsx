  ...
  return (
    <div className="xl:pb-[143px] xs:pb-[100px] ">
      <div className="flex xl:flex-row xs:flex-col  lg:gap-52  xs:gap-[74px]">
        <div className="lg:text-[80px] lg:leading-[88px] xs:text-[48px] xs:leading-[52px] md:min-w-[470px]">Staff Augmentation</div>
        <div className="font-tahoma lg:text-[26px] xs:text-[24px] lg:leading-[35.1px] xs:leading-[32px] pt-5">
        Mana'o Pili provides Staff Augmentation Services to help organizations scale with skilled professionals for short-term projects, long-term initiatives, or specialized ServiceNow expertise. Our flexible staffing solutions ensure the right talent is available when you need it.
